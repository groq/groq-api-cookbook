...
async def entrypoint(ctx: JobContext):
    ...
    assistant = VoiceAssistant(
        ...
        stt=groq.STT(), # view all speech-in models here: https://console.groq.com/docs/speech-to-text
        llm=groq.LLM(
            model="llama3-8b-8192", # view all LLMs to choose from here: https://console.groq.com/docs/models
        ),
        tts=groq.TTS(
            voice="Chip-PlayAI", # view all speech-out models here: https://console.groq.com/playground?model=playai-tts
        ),
